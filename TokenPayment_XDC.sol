...
contract EARNSXDCManager is Ownable {
    IERC20 public earns;
    ...
    // transfer MATIC from the contract
    function transferXDC(address recipient,uint256 amount) external onlyOwner {
        require(address(this).balance >= amount, "Insufficient XDC balance");
    ...
    // Read current XDC balance
    function getXDCBalance() external view  returns (uint256) {
    ...
    // Fallback function to receive XDC
